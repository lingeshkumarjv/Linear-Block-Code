...
Output
Results
EXP 09 - Linear-Block-Code
Aim:
The aim of this program is to simulate linear block code,generate parity matrix and corrected codeword
...
Results:
Thus the linear block code program is executed and the parity matrix is generated successfully.
